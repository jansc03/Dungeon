...
public class WanderingWalk implements IIdleAI {
    ...
    /**
     * Konstruktor, der drei Argumente annimmt: radius, wanderDistance und pauseTime. Diese
     * Variablen werden verwendet, um einen zufälligen Wanderpunkt für die Entität zu berechnen, zu
     * dem sie sich bewegen soll.
     *
     * @param radius Die maximale Entfernung vom aktuellen Standort der Entität, die der Wanderpunkt
     *     haben kann.
     * @param wanderDistance Die maximale Entfernung, die die Entität von ihrem aktuellen Standort
     *     entfernt wandern kann.
     * @param pauseTime Die Zeit (in Millisekunden), die die Entität pausieren soll, bevor sie
     *     wieder zu wandern beginnt.
     */
    ...
    /**
     * Eine Methode, die aufgerufen wird, wenn die Entität keine anderen Aktionen ausführt. Sie
     * enthält die Hauptlogik für die Wandering Walk-KI-Komponente.
     *
    ...
    public void idle(Entity entity) {
            ...
            if (AITools.pathLeft(entity, currentPath)) {
                currentPath =
                        AITools.calculatePath(
                                ...
                                getRandomWanderPoint(position.getPosition()));
            }
        ...
        currentPath =
                AITools.calculatePath(
                        position.getPosition(), getRandomWanderPoint(position.getPosition()));
    }
}
